...
export const PLUGINS: Plugin[] = [
  {
    name: "@fastify/cors",
    description: "Enable CORS in a Fastify application.",
    category: "Core",
    official: true,
  ...
  {
    name: "@fastify/jwt",
    description: "JWT utils for Fastify, internally uses fast-jwt.",
    category: "Auth",
    official: true,
  ...
  {
    name: "@fastify/oauth2",
    description: "Wrap around simple-oauth2 for OAuth flows.",
    category: "Auth",
    official: true,
  ...
  },
  {
    ...
    description: "Fastify PostgreSQL connection plugin using pg.",
    category: "Database",
    official: true,
    url: "https://github.com/fastify/fastify-postgres",
  },
  {
    name: "@fastify/mongodb",
    description: "Fastify MongoDB connection plugin, shares pool across routes.",
    category: "Database",
    official: true,
  ...
  {
    name: "@fastify/redis",
    description: "Shared Redis connection across your Fastify server.",
    category: "Database",
    official: true,
    url: "https://github.com/fastify/fastify-redis",
  },
  {
    name: "@fastify/swagger",
    description: "Serve Swagger/OpenAPI definitions from your routes.",
    category: "Utilities",
    official: true,
  ...
  },
  {
    ...
    description: "Parse multipart/form-data content type.",
    category: "Utilities",
    official: true,
  ...
  {
    name: "@fastify/cookie",
    description: "Parse and set cookie headers.",
    category: "Core",
    official: true,
  ...
  },
  {
    ...
    description: "WebSocket support for Fastify, built upon ws.",
    category: "Utilities",
    official: true,
  ...
  {
    name: "@fastify/view",
    description: "Templating engine (ejs, pug, handlebars, and more).",
    category: "View",
    official: true,
  ...
  {
    name: "@fastify/env",
    description: "Load and validate environment variables at startup.",
    category: "Validation",
    official: true,
  ...
  },
  {
    ...
    description: "Zod type provider for end-to-end type safety.",
    category: "Validation",
